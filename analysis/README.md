...
**Mixed Race** contains mixed race data and visualizations.

**Dotplots** contains scripts to make racial + gender dotplots.

**Salary** contains scripts related to salary analysis.
